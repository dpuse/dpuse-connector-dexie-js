...
var { liveQuery: d, mergeRanges: f, rangesOverlap: p, RangeSet: m, cmp: h, Entity: g, PropModification: _, replacePrefix: v, add: y, remove: b, DexieYProvider: x } = u, S = class extends Error {
	...
	version: "0.2.290"
}, w = "0.2.290", te = "Encountered invalid container identifier", T = "Encountered invalid folder path", E = "Encountered invalid object path", ne = class {
	abortController;
	config;
	engineUtilities;
	toolConfigs;
