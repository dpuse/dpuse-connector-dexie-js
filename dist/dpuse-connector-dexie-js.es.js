...
var e = Object.create, t = Object.defineProperty, n = Object.getOwnPropertyDescriptor, r = Object.getOwnPropertyNames, i = Object.getPrototypeOf, a = Object.prototype.hasOwnProperty, o = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), s = (e, i, o, s) => {
	...
	((n, r) => {
		...
		}, {}), ge = (k.Syntax = SyntaxError, k.Type = TypeError, k.Range = RangeError, w.reduce(function(e, t) {
		...
		w.ModifyError = fe, w.DexieError = ue, w.BulkError = pe;
		...
		var B = P.reject, ut = "￿", V = "Invalid key provided. Keys must be of type string, number, Date or Array<string | number | Date>.", dt = "String expected.", ft = [], pt = "__dbnames", mt = "readonly", ht = "readwrite";
		function gt(e, t) {
			return e ? t ? function() {
		...
		function H(e, t) {
			try {
				...
				switch (n) {
					...
					case "binary":
						for (var i = xt(e), a = xt(t), o = i.length, s = a.length, c = o < s ? o : s, l = 0; l < c; ++l) if (i[l] !== a[l]) return i[l] < a[l] ? -1 : 1;
		...
		wt.prototype.execute = function(e) {
			var t = this["@@propmod"];
			if (t.add !== void 0) {
				var r = t.add;
		...
		function Tt(e, t) {
			for (var n = i(t), r = n.length, a = !1, o = 0; o < r; ++o) {
				...
				c instanceof Ct ? (x(e, s, c.execute(l)), a = !0) : l !== c && (x(e, s, c), a = !0);
			}
			return a;
		}
		U.prototype._trans = function(e, t, n) {
			...
			var s = t.reduce(function(t, n) {
				...
				return [i || s, i || !s ? gt(t, s && s.multi ? function(e) {
			...
			for (var n = this.db, r = this.name, i = ((this.schema.mappedClass = t).prototype instanceof yt && (t = ((t) => {
				var i = s, a = t;
			...
			return this._trans("readwrite", function(i) {
				return n.core.get({
					...
					var o = a ?? {};
					return Tt(o, t), r && x(o, r, e), n.core.mutate({
						trans: i,
						type: "put",
						values: [o],
						keys: [e],
			...
			return this._trans("readwrite", function(t) {
				...
				var s = e.length, o = n && o ? e.map(vt(n)) : e;
		...
		function Pt(e, t, n, r) {
			var i, a, o = e.replayFilter ? gt(e.filter, e.replayFilter()) : e.filter;
			...
			}, Promise.all([e.or._iterate(a, n), Ft(Nt(e, r, n), e.algorithm, a, !e.keysOnly && e.valueMapper)])) : Ft(Nt(e, r, n), gt(e.algorithm, o), t, !e.keysOnly && e.valueMapper);
		}
		function Ft(e, t, n, r) {
		...
		W.prototype._read = function(e, t) {
			...
			return this._read(function(e) {
				var n, r, i, a = t._ctx;
				return a.dir === "next" && kt(a, !0) && 0 < a.limit ? (n = a.valueMapper, r = Mt(a, a.table.core.schema), a.table.core.query({
					trans: e,
					limit: a.limit,
					values: !0,
					query: {
			...
			return t && t.multi && (e = {}, At(this._ctx, function(t) {
			...
			return this._write(function(r) {
				...
				var o = typeof e == "function" ? e : function(t) {
					return Tt(t, e);
				}, s = n.table.core, c = s.schema.primaryKey, l = c.outbound, u = c.extractKey, d = 200, c = t.db._options.modifyChunkSize, f = (c && (d = typeof c == "object" ? c[s.name] || c["*"] || 200 : c), []), p = 0, m = [], h = e === Lt;
				return t.clone().primaryKeys().then(function(t) {
					...
					var c = kt(n) && n.limit === Infinity && (typeof e != "function" || h) && {
						index: n.index,
						range: n.range
					};
			...
			return !kt(e) || e.table.schema.yProps || !e.isPrimKey && t.type !== 3 ? this.modify(Lt) : this._write(function(n) {
		...
		Object.defineProperty(q.prototype, "Collection", {
			...
			return r.length === 0 ? Bt(this) : ((e = new this.Collection(this, function() {
		...
		var Gt = "storagemutated", Kt = "x-storagemutated-1", Y = Dt(null, Gt), qt = (X.prototype._lock = function() {
			...
			if (this.mode) {
				...
				v(this._completion._state === null), (e = this.idbtrans = e || (this.db.core || n).transaction(this.storeNames, this.mode, { durability: this.chromeTransactionDurability })).onerror = F(function(n) {
					...
					Wt(n), t.active && t._reject(new k.Abort(e.error)), t.active = !1, t.on("abort").fire(n);
				...
				return {
					...
					query: (t = c, function(e) {
						return new Promise(function(i, a) {
							...
							}, f.onerror = J(a)) : (o = 0, s = !u && "openKeyCursor" in l ? l.openKeyCursor(m) : l.openCursor(m), c = [], s.onsuccess = function(e) {
								var t = s.result;
		...
		function ln(e, t, n, r) {
			var a = e._dbSchema, o = (n.objectStoreNames.contains("$meta") && !a.$meta && (a.$meta = Xt("$meta", _n("")[0], []), e._storeNames.push("$meta")), e._createTransaction("readwrite", e._storeNames, a)), s = (o.create(n), o._completion.catch(r), o._reject.bind(o)), c = N.transless || N;
			L(function() {
				if (N.trans = o, N.transless = c, t !== 0) return an(e, n), l = t, ((r = o).storeNames.includes("$meta") ? r.table("$meta").get("version").then(function(e) {
					return e ?? l;
					...
					return (t = t.filter(function(e) {
						...
						l.push(function() {
							...
							if (p && e._cfg.version > a) return an(r, c), s._memoizedTables = {}, t = S(d), f.del.forEach(function(e) {
								t[e] = l[e];
							}), sn(r, [r.Transaction.prototype]), on(r, [r.Transaction.prototype], i(t), t), s.schema = t, (n = ce(p)) && rt(), d = P.follow(function() {
								var e;
			...
			for (var r = 0, i = dn(n, e._dbSchema).change; r < i.length; r++) {
				var a = ((e) => {
					...
					e.add.forEach(function(t) {
						j && console.debug(`Dexie upgrade patch: Creating missing index ${e.name}.${t.src}`), mn(n, t);
					});
				})(i[r]);
		...
		function pn(e, t) {
			i(e).forEach(function(n) {
				t.db.objectStoreNames.contains(n) || (j && console.debug("Dexie: Creating missing table", n), fn(t, n, e[n].primKey, e[n].indexes));
			});
		}
		function mn(e, t) {
		...
		function bn(e, t) {
			var n = e._dbNamesDB;
			return n || (n = e._dbNamesDB = new Q(pt, {
				addons: [],
				indexedDB: e,
				IDBKeyRange: t
			...
			function c() {
				return new P(function(r, l) {
					...
					p.onerror = J(l), p.onblocked = F(e._fireOnBlocked), p.onupgradeneeded = F(function(r) {
						var i;
						d = p.transaction, t.autoSchema && !e._options.allowEmptyDB ? (p.onerror = Wt, d.abort(), p.result.close(), (i = n.deleteDatabase(u)).onsuccess = i.onerror = F(function() {
							l(new k.NoSuchDatabase(`Database ${u} doesnt exist`));
						})) : (d.onerror = J(l), i = r.oldVersion > 2 ** 62 ? 0 : r.oldVersion, f = i < 1, e.idbdb = p.result, o && un(e, d), ln(e, i / 10, d, l));
						...
						ft.push(e), v.onversionchange = F(function(n) {
							t.vcFired = !0, e.on("versionchange").fire(n);
						}), v.onclose = F(function() {
							e.close({ disableAutoOpen: !1 });
						}), f && (y = e._deps, h = u, xn(_ = y.indexedDB) || h === pt || bn(_, y.IDBKeyRange).put({ name: h }).catch(A)), r();
					}, l);
				}).catch(function(e) {
					switch (e?.name) {
						case "UnknownError":
									...
									for (var o = /* @__PURE__ */ new Set(), c = 0, l = t; c < l.length; c++) {
										...
										if (d) {
											...
											if (s._explicit && i && s.mutatedParts) for (var m = 0, h = Object.values(d.queries.query); m < h.length; m++) for (var g = 0, _ = (b = h[m]).slice(); g < _.length; g++) jn((x = _[g]).obsSet, s.mutatedParts) && (oe(b, x), x.subscribers.forEach(function(e) {
												...
												for (var v = 0, y = Object.values(d.queries.query); v < y.length; v++) for (var b, x, S, C = 0, ee = (b = y[v]).slice(); C < ee.length; C++) (x = ee[C]).res != null && s.mutatedParts && (i && !x.dirty ? (S = Object.isFrozen(x.res), S = Qn(x.res, x.req, p, f, x, S), x.dirty ? (oe(b, x), x.subscribers.forEach(function(e) {
													return o.add(e);
		...
		$.prototype.version = function(e) {
			...
			return new P(function(i, a) {
				function o() {
					...
					n.onsuccess = F(function() {
						...
						xn(r = e.indexedDB) || n === pt || bn(r, e.IDBKeyRange).delete(n).catch(A), i();
			...
			try {
				if (i = t.map(function(e) {
					...
					if (e != "rw" && e != ht) throw new k.InvalidArgument("Invalid transaction mode: " + e);
					r = ht;
				}
				if (o) {
					if (o.mode === mt && r === ht) {
		...
		function $(e, n) {
			var r, i, a, o, s, c = this, l = (this._middlewares = {}, this.verno = 0, $.dependencies), l = (this._options = n = t({
				...
				u.cancelOpen = t;
			}), this._state = u, this.name = e, this.on = Dt(this, "populate", "blocked", "versionchange", "close", { ready: [we, A] }), this.once = function(e, t) {
				var n = function() {
					var r = [...arguments];
			...
			}), this.Collection = (r = this, Ot(It.prototype, function(e, t) {
				this.db = r;
				var n = _t, i = null;
				if (t) try {
					n = t();
			...
			})), this.Table = (i = this, Ot(Et.prototype, function(e, t, n) {
				this.db = i, this._tx = n, this.name = e, this.schema = t, this.hook = i._allTables[e] ? i._allTables[e].hook : Dt(null, {
					creating: [be, A],
					reading: [ve, _e],
					updating: [Se, A],
					deleting: [xe, A]
				});
			})), this.Transaction = (a = this, Ot(qt.prototype, function(e, t, n, r, i) {
				var o = this;
				e !== "readonly" && t.forEach(function(e) {
					e = (e = n[e])?.yProps, e && (t = t.concat(e.map(function(e) {
						return e.updatesTable;
					})));
				}), this.db = a, this.mode = e, this.storeNames = t, this.schema = n, this.chromeTransactionDurability = r, this.idbtrans = null, this.on = Dt(this, "complete", "error", "abort"), this.parent = i || null, this.active = !0, this._reculock = 0, this._blockedFuncs = [], this._resolve = null, this._reject = null, this._waitingFor = null, this._waitingQueue = null, this._spinCount = 0, this._completion = new P(function(e, t) {
			...
			})), this.Version = (o = this, Ot(vn.prototype, function(e) {
				this.db = o, this._cfg = {
					version: e,
					storesSource: null,
					dbschema: {},
			...
			})), this.WhereClause = (s = this, Ot(Ut.prototype, function(e, t, n) {
				...
				c.on("blocked").fire(e), ft.filter(function(e) {
				...
				} : (r = Reflect.get(e, t, n)) instanceof Et ? rr(r, d) : t === "tables" ? r.map(function(e) {
					return rr(e, d);
		...
		})), cr.maxKey = Zt(cr.dependencies.IDBKeyRange), typeof dispatchEvent < "u" && typeof addEventListener < "u" && (Y(Gt, function(e) {
		...
		return typeof BroadcastChannel < "u" && ((fr = function() {
		...
		})(), typeof ur.unref == "function" && ur.unref(), Y(Gt, function(e) {
			dr || ur.postMessage(e);
			...
			rangesOverlap: En,
			remove: function(e) {
				return new Ct({ remove: e });
			},
			replacePrefix: function(e, t) {
				return new Ct({ replacePrefix: [e, t] });
			}
		}), { default: Q }), Q;
	});
...
var { liveQuery: d, mergeRanges: f, rangesOverlap: p, RangeSet: m, cmp: h, Entity: g, PropModification: _, replacePrefix: v, add: y, remove: b, DexieYProvider: x } = u, S = class extends Error {
	data;
	locator;
	constructor(e, t, n, r) {
	...
	async createObject(e) {
		let { containerId: t, nodeId: n } = this.establishObjectIdentifiers(e.path), r = await this.establishContainer(t);
		if (r.tables.some((e) => e.name === n)) throw Error(`Duplicate table '${n}'.`);
		r.close();
		let i = new u(r.name);
		if (i.on("blocked", () => !1), r.tables.length === 0) {
			await r.delete(), i.version(1).stores({ [n]: e.structure || "" }), this.containers[t] = await i.open();
			return;
		}
		let a = {};
		for (let { name: e, schema: t } of r.tables) a[e] = [t.primKey.src, ...t.indexes.map((e) => e.src)].join(",");
		i.version(r.verno).stores(a), i.version(r.verno + 1).stores({ [n]: e.structure || "" }), this.containers[t] = await i.open();
	}
	async dropObject(e) {
		let { containerId: t, nodeId: n } = this.establishObjectIdentifiers(e.path), r = await this.establishContainer(t);
		if (!r.tables.some((e) => e.name === n)) throw Error(`Table '${n}' not found.`);
		r.close();
		let i = new u(r.name);
		if (i.on("blocked", () => !1), r.tables.length === 1) {
			await r.delete(), i.version(1).stores({}), this.containers[t] = await i.open();
			return;
		}
		let a = {};
		for (let { name: e, schema: t } of r.tables) a[e] = [t.primKey.src, ...t.indexes.map((e) => e.src)].join(",");
	...
	async getRecord(e) {
		let { containerId: t, nodeId: n } = this.establishObjectIdentifiers(e.path), r = await (await this.establishContainer(t)).table(n).get(e.id);
	...
	async listNodes(e) {
		...
		switch (t.length) {
			...
			case 2: {
				if (t[0] != null) throw Error(`${T} '${e.folderPath}'.`);
				let n = t[1];
				if (n == null) throw Error(`${T} '${e.folderPath}'.`);
				let r = (await this.establishContainer(n)).tables.map((t) => ({
					folderPath: e.folderPath,
					id: t.name,
					label: t.name,
					name: t.name,
			...
			default: throw Error(`${T} '${e.folderPath}'.`);
		}
	}
	async previewObject(e) {
		let { containerId: t, nodeId: n } = this.establishObjectIdentifiers(e.path);
		return await (await this.establishContainer(t)).table(n).limit(50).toArray(), {
			asAt: Date.now(),
			columnConfigs: [],
	...
	async upsertRecords(e) {
		let { containerId: t, nodeId: n } = this.establishObjectIdentifiers(e.path), r = await this.establishContainer(t), i = e.records;
		i.length === 1 ? await r.table(n).put(i[0]) : i.length > 1 && await r.table(n).bulkPut(i);
	}
	async removeRecords(e) {
		let { containerId: t, nodeId: n } = this.establishObjectIdentifiers(e.path), r = await this.establishContainer(t), i = e.keys;
		i.length === 0 ? await r.table(n).clear() : i.length === 1 && i[0] != null ? await r.table(n).delete(i[0]) : await r.table(n).bulkDelete(i);
	}
	async retrieveRecords(e, t, n) {
		try {
			let { containerId: r, nodeId: i } = this.establishObjectIdentifiers(e.path), a = await (await this.establishContainer(r)).table(i).toArray();
			t("jsonRecordArray", a), n({
				byteCount: 0,
				commentLineCount: 0,
				emptyLineCount: 0,
				lineCount: 0,
				nonUniformRecordCount: 0,
				recordCount: a.length
			});
		} catch (t) {
			throw new C(`Failed to access Dexie table with path '${e.path}'.`, "dpu-connector-dexie-js.index.retrieveRecords", { cause: t });
		} finally {
			this.abortController = void 0;
		}
	}
	async establishContainer(e) {
		if (!this.containers[e]) {
			let t = new u(e);
			await u.exists(t.name) || t.version(1).stores({}), this.containers[e] = await t.open();
		}
		return this.containers[e];
	}
	establishObjectIdentifiers(e) {
		let t = e.split("/"), [, n, r] = t;
		if (t.length !== 3 || n === void 0 || n === "" || r === void 0 || r === "") throw Error(`${E} '${e}'.`);
		return {
			containerId: n,
			nodeId: r
		};
...
//#endregion
export { ne as Connector };

//# sourceMappingURL=dpuse-connector-dexie-js.es.js.map