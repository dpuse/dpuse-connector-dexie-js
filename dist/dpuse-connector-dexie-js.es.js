...
var { liveQuery: d, mergeRanges: f, rangesOverlap: p, RangeSet: m, cmp: h, Entity: g, PropModification: _, replacePrefix: v, add: y, remove: b, DexieYProvider: x } = u, S = class extends Error {
	...
	iconNeutral: "<svg viewBox=\"2 9 48 34\" fill=\"none\"><path d=\"M2 29.668C2 29.0378 2.73382 28.6798 3.2512 29.0302C7.27034 31.7516 12.121 32.3835 16.9587 32.3835C18.2911 32.3835 19.3816 33.4786 19.3816 34.8275V40.4163C19.3816 41.7826 18.3083 42.8888 16.9587 42.8888C14.8782 42.8888 6.8721 42.8088 3.05343 38.9426C2.39504 38.1427 2 37.3695 2 36.063V29.668Z\" fill=\"black\"/><path d=\"M16.827 9C17.0823 9 17.624 9.00193 18.1545 9.00569C18.838 9.01054 19.3816 9.57177 19.3816 10.2638V11.0829C19.3816 11.8071 18.7882 12.3956 18.0728 12.3907C17.6399 12.3877 17.2274 12.3862 17.0377 12.3862C9.76903 12.3862 5.3973 14.5193 5.3973 15.2658C5.3973 16.0124 9.74269 18.1454 17.0377 18.1454C18.3194 18.1454 19.3816 19.2001 19.3816 20.4977V26.365C19.3816 27.7175 18.3209 28.8107 16.985 28.8107C10.6118 28.8107 5.05494 27.0242 3.00076 24.9445C2.63206 24.5712 2 23.8993 2 23.3447V15.2392C2 13.986 2.79007 12.5757 4.52823 11.5597C8.13622 9.45069 13.8247 9 16.827 9Z\" fill=\"black\"/><path d=\"M34.0334 43H22.8857V9.69409H34.2583C37.5244 9.69409 40.3301 10.3609 42.6753 11.6944C45.0312 13.0171 46.841 14.9198 48.1046 17.4026C49.3682 19.8854 50 22.856 50 26.3145C50 29.7839 49.3628 32.7654 48.0885 35.259C46.8249 37.7526 44.9991 39.6662 42.611 40.9997C40.2337 42.3332 37.3745 43 34.0334 43ZM28.8451 37.7797H33.7443C36.0359 37.7797 37.9474 37.3569 39.4788 36.5112C41.0101 35.6547 42.1613 34.3808 42.9323 32.6895C43.7033 30.9873 44.0888 28.8623 44.0888 26.3145C44.0888 23.7667 43.7033 21.6526 42.9323 19.9721C42.1613 18.2808 41.0208 17.0177 39.5109 16.1829C38.0117 15.3372 36.1484 14.9144 33.921 14.9144H28.8451V37.7797Z\" fill=\"black\"/></svg>",
	lastUpdatedAt: null,
	status: null,
	statusId: "alpha",
	typeId: "connector",
...
}, w = "0.2.318", te = "Encountered invalid container identifier", T = "Encountered invalid folder path", E = "Encountered invalid object path", ne = class {
	abortController;
	config;
	connectorUtilities;
	toolConfigs;
